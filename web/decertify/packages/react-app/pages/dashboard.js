...
function tableData(props){
  <tr class="border-b dark:border-gray-700">
      ...
      <td class="px-4 py-3">props.reqid</td>
      <td class="px-4 py-3">props.title</td>
      <td class="px-4 py-3">props.descp</td>
      <td class="px-4 py-3">props.dept</td>
      <td class="px-4 py-3">props.status</td>
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tableData reqid='1' descp='xyz' dept='x' status='approved'/>
                    </tbody>
                </table>
            </div>
